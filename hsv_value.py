...
while True:
    ...
    if time.time() - ultimo_tiempo_actualizacion > intervalo_actualizacion:
        ...
        hsv_min[2] += 5  # Modificar el valor H mínimo
        if hsv_min[2] >= 255:
            hsv_min[2] = 0  # Reiniciar si supera 180
        hsv_max[2] = hsv_min[2] + 70  # Actualizar el valor H máximo
